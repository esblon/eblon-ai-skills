...
- **ADR** (Architecture Decision Record) dans `docs/adr/NNNN-titre.md` — utiliser le skill `/solution_adr`
...
<!-- Section enrichie au fil de l'eau via /skill-enrich architect_fr -->
